...
<svg
  ...
  ><path
    fill="#FFCC4D"
    d="M33 21c0 8.284-6.716 15-15 15S3 29.284 3 21C3 12.716 9.716 6 18 6s15 6.716 15 15"
  /><path
    fill="#664500"
  ...
  /><path
    fill="#664500"
    d="M11 6s2.074 2 7 2c4.927 0 7-2 7-2v2s-2.222 2-7 2c-4.778 0-7-2-7-2V6z"
  /></svg
>
...
@prop export let ariaLabel = '1f920';
-->
