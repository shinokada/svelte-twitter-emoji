...
<svg
  ...
  viewBox="0 0 36 36"
  xml:space="preserve"
  ><path fill="#898379" d="M6 23c-4 0-4.5 2.5-4.5 2.5L0 25v11h36V25l-1 1s-1-3-4-3H6z" /><path
    fill="#4A4153"
  ...
  /><path
    ...
    fill="#77B255"
  /><path d="M13 27v-2s2 .667 2 2h-2zm10 0v-2s-2 .667-2 2h2z" fill="#FFEBA5" /></svg
>
...
@prop export let ariaLabel = '1f9cc';
-->
