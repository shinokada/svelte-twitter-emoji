<script>
  export let size = '36';
  export let role = 'img';
  export let ariaLabel = '1f645 1f3fd 200d 2640 fe0f';
</script>
...
<svg
  ...
  /><path
    fill="#D5AB88"
    d="M14 5s-.003 5.308-5 5.936V17c0 4.971 4.029 9 9 9s9-4.029 9-9v-5.019C15.889 11.605 14 5 14 5z"
  /><circle fill="#DF1F32" cx="18" cy="22" r="1" /><path fill="#7450A8" d="M6 28h24v8H6z" /><path
    fill="#C1694F"
...
@prop export let ariaLabel = '1f645 1f3fd 200d 2640 fe0f';
-->
