<script>
  ...
  export let ariaLabel = '1f1ea 1f1f8';
</script>
...
<svg
  ...
  /><path fill="#FFC400" d="M0 12h36v12H0z" /><path
    fill="#EA596E"
    d="M9 17v3c0 1.657 1.343 3 3 3s3-1.343 3-3v-3H9z"
  /><path fill="#F4A2B2" d="M12 16h3v3h-3z" /><path fill="#DD2E44" d="M9 16h3v3H9z" /><ellipse
    ...
    rx="3"
    ry="1.5"
  /><ellipse fill="#FFAC33" cx="12" cy="13.75" rx="3" ry=".75" /><path
    fill="#99AAB5"
...
@prop export let ariaLabel = '1f1ea 1f1f8';
-->
