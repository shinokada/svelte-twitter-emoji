...
<svg
  ...
  /><path
    fill="#292F33"
    d="M25.362 30.636C24.879 29.87 21.947 25.5 18 25.5c-4.234 0-7.3 5.028-7.428 5.243-.121.2-.085.457.084.619.094.091.219.138.344.138.096 0 .193-.027.277-.084.029-.02 2.918-1.916 6.723-1.916 3.792 0 6.695 1.897 6.723 1.916.086.058.215.096.281.084.277-.004.516-.219.516-.5 0-.144-.06-.272-.158-.364z"
  /><g fill="#292F33"
    ...
    /></g
  ><path fill="#5DADEC" d="M15 31c0 2.762-2.239 5-5 5s-5-2.238-5-5 4-13 5-13 5 10.238 5 13z" /></svg
>
...
@prop export let ariaLabel = '1f63f';
-->
