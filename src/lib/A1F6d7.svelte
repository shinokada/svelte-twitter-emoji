...
<svg
  ...
  /><path
    fill="#FFF"
    d="M30 34H6c-1.654 0-3-1.346-3-3V13c0-1.654 1.346-3 3-3h24c1.654 0 3 1.346 3 3v18c0 1.654-1.346 3-3 3zM6 12c-.551 0-1 .449-1 1v18c0 .552.449 1 1 1h24c.552 0 1-.448 1-1V13c0-.551-.448-1-1-1H6zm7-9.828L9.172 6H11.5v3h3V6h2.328zm11.5 3v-3h-3v3h-2.328L23 9l3.828-3.828z"
  /><path
    fill="#FFF"
...
@prop export let ariaLabel = '1f6d7';
-->
