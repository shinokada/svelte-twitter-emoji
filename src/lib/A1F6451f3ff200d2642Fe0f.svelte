<script>
  ...
  export let ariaLabel = '1f645 1f3ff 200d 2642 fe0f';
</script>
...
<svg
  ...
  ><path
    fill="#7C533E"
    d="M28.752 13.715c0-1.548-.769-2.801-1.729-2.852V6.25l-18-.312v4.926c-.96.051-1.729 1.304-1.729 2.852 0 1.548.77 2.801 1.729 2.852V17c0 4.971 4.029 9 9 9s9-4.029 9-9v-.433c.96-.051 1.729-1.304 1.729-2.852z"
  /><path
    fill="#0B0200"
    d="M18.023.823c-7.019 0-10.139 4.684-10.139 8.588 0 3.903 1.343 4.986 1.56 3.903.78-3.903 3.12-5.101 3.12-5.101 4.68 3.904 3.9.781 3.9.781 4.679 4.684 2.34 0 2.34 0 1.56 1.562 6.239 1.562 6.239 1.562s.78 1.198 1.559 2.759c.78 1.562 1.56 0 1.56-3.903 0-3.905-3.9-8.589-10.139-8.589z"
  /><path fill="#3D2E24" d="M14.023 22h8s-1 2-4 2-4-2-4-2z" /><path
    fill="#2A6797"
    d="M6 28h24v8H6z"
  /><path
    fill="#3D2E24"
    d="M19.023 19.5h-2c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h2c.276 0 .5.224.5.5s-.224.5-.5.5z"
  /><path
    d="M14.023 16c-.552 0-1-.448-1-1v-1c0-.552.448-1 1-1s1 .448 1 1v1c0 .552-.448 1-1 1zm8 0c-.552 0-1-.448-1-1v-1c0-.552.448-1 1-1s1 .448 1 1v1c0 .552-.448 1-1 1z"
  /><path
    fill="#664131"
...
@prop export let ariaLabel = '1f645 1f3ff 200d 2642 fe0f';
-->
