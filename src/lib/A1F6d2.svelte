...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#CCD6DD" d="M31 22H11L9 10h24z" /><path
    fill="#66757F"
  ...
  /><circle fill="#E1E8ED" cx="14" cy="31" r="3" /><path
    fill="#292F33"
    d="M14 35c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4zm0-6c-1.103 0-2 .897-2 2s.897 2 2 2 2-.897 2-2-.897-2-2-2z"
  /><circle fill="#E1E8ED" cx="28" cy="31" r="3" /><path
    fill="#292F33"
    d="M28 35c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4zm0-6c-1.103 0-2 .897-2 2s.897 2 2 2 2-.897 2-2-.897-2-2-2z"
  /></svg
>
...
@prop export let ariaLabel = '1f6d2';
-->
