<script>
  ...
  export let ariaLabel = '1f64d 1f3ff';
</script>
...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#FA743E" d="M27 27H9c-2.209 0-4 1.791-4 4v5h26v-5c0-2.209-1.791-4-4-4z" /><path
    fill="#DD551F"
    d="M9 32h1v4H9zm17 0h1v4h-1z"
  /><path
    fill="#0B0200"
  ...
  /><path
    d="M14 17c-.552 0-1-.448-1-1v-1c0-.552.448-1 1-1s1 .448 1 1v1c0 .552-.448 1-1 1zm8 0c-.552 0-1-.448-1-1v-1c0-.552.448-1 1-1s1 .448 1 1v1c0 .552-.448 1-1 1z"
...
@prop export let ariaLabel = '1f64d 1f3ff';
-->
