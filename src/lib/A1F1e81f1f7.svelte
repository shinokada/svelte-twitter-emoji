<script>
  ...
  export let ariaLabel = '1f1e8 1f1f7';
</script>
...
<svg
  ...
  /><path fill="#EEE" d="M0 9h36v18H0z" /><path fill="#CE1225" d="M0 13h36v10H0z" /><ellipse
    fill="#EEE"
    cx="8.5"
    cy="18"
    rx="3.5"
  ...
  /><ellipse fill="#DCA841" cx="8.5" cy="18.5" rx="1.5" ry=".5" /></svg
>
...
@prop export let ariaLabel = '1f1e8 1f1f7';
-->
