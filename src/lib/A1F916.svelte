...
<svg
  ...
  /><path fill="#55ACEE" d="M30 6H6c-1.104 0-2 .896-2 2v26h28V8c0-1.104-.896-2-2-2z" /><path
    fill="#3B88C3"
  ...
  /><circle fill="#FFF" cx="24.5" cy="14.5" r="4.5" /><circle
    ...
    cy="14.5"
    r="2.721"
  /><circle fill="#FFF" cx="11.5" cy="14.5" r="4.5" /><path
    fill="#F5F8FA"
  ...
  /><circle fill="#DD2E44" cx="11.5" cy="14.5" r="2.721" /></svg
>
...
@prop export let ariaLabel = '1f916';
-->
