...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#FFDC5D" d="M3 26h8v10H3zm22 0h8v10h-8z" /><path
    fill="#F9CA55"
    d="M33 28.72s-3 2-8 1v-5h8v4zm-30 0s3 2 8 1v-5H3v4z"
  /><path fill="#EF9645" d="M3.983 18.604h8v8h-8zm20.023-.5h8v8h-8z" /><path
    fill="#FFDC5D"
...
@prop export let ariaLabel = '1f64c';
-->
