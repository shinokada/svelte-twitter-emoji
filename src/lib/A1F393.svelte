...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#31373D" d="M24 14H12s-5 6-5 10 11 11 11 11 11-7 11-11-5-10-5-10z" /><path
    fill="#292F33"
  ...
  /><path fill="#FCAB40" d="M8 25s-2 2-2 3v6s0 2 2 2 2-2 2-2v-6c0-1-2-3-2-3z" /><circle
    fill="#FDD888"
    cx="8"
    cy="26"
    r="3"
  ...
  /><circle fill="#31373D" cx="18" cy="13" r="3" /></svg
>
...
@prop export let ariaLabel = '1f393';
-->
