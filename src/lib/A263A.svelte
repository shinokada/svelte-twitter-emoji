...
<svg
  ...
  /><circle fill="#FF7892" cx="29" cy="22" r="5" /><circle
    fill="#FF7892"
    cx="7"
    cy="22"
    r="5"
  ...
  /><g fill="#664500"
    ><path d="M13 25s1 4 5 4 5-4 5-4-1 1-5 1-5-1-5-1z" /><path
      d="M18 29.5c-4.34 0-5.474-4.335-5.485-4.379-.055-.218.043-.445.238-.557.191-.106.43-.079.591.072.039.034 1.066.864 4.656.864 3.644 0 4.647-.855 4.657-.863.165-.146.409-.171.597-.06.188.113.284.331.231.544-.011.044-1.145 4.379-5.485 4.379zm-4.051-3.492C14.526 27.072 15.724 28.5 18 28.5s3.475-1.428 4.051-2.492c-.82.258-2.101.492-4.051.492s-3.231-.234-4.051-.492zM13 25h.01H13z"
    /></g
  ></svg
>
...
@prop export let ariaLabel = '263a';
-->
