...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#BE1931" d="M23.651 23.297L12.702 12.348l9.386-7.821 9.385 9.385z" /><path
    fill="#DD2E44"
  ...
  /><path
    fill="#99AAB5"
    d="M14 17.823S-.593 35.029.188 35.813C.97 36.596 18.177 22 18.177 22L14 17.823z"
  /><path
    fill="#DD2E44"
...
@prop export let ariaLabel = '1f4cc';
-->
