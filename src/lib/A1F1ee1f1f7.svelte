<script>
  ...
  export let ariaLabel = '1f1ee 1f1f7';
</script>
...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#DA0001" d="M0 27c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4v-4H0v4z" /><path
    fill="#EEE"
    d="M0 13h36v10H0z"
  /><path fill="#239F40" d="M36 13V9c0-2.209-1.791-4-4-4H4C1.791 5 0 6.791 0 9v4h36z" /><path
    fill="#E96667"
    d="M0 23h36v1H0z"
  /><g fill="#BE1931"
    ><path
    ...
    /></g
  ><path fill="#7BC58C" d="M0 12h36v1H0z" /></svg
>
...
@prop export let ariaLabel = '1f1ee 1f1f7';
-->
