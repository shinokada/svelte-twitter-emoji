<script>
  ...
  export let ariaLabel = '1f1f2 1f1f9';
</script>
...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#CF142B" d="M32 5H18v26h14c2.209 0 4-1.791 4-4V9c0-2.209-1.791-4-4-4z" /><path
    fill="#EEE"
    d="M4 5C1.791 5 0 6.791 0 9v18c0 2.209 1.791 4 4 4h14V5H4z"
  /><path fill="#CF142B" d="M1.654 9.656h8.691v2.688H1.654z" /><path
    fill="#CF142B"
    d="M4.656 6.654h2.688v8.691H4.656z"
  /><g fill="#CF142B"
    ><circle cx="4.71" cy="12.271" r=".921" /><circle cx="7.355" cy="12.271" r=".921" /><circle
      cx="4.71"
      cy="9.824"
      r=".921"
    /><circle cx="7.355" cy="9.824" r=".921" /></g
  ><g fill="#99AAB5"
    ><circle cx="4.708" cy="12.271" r=".708" /><circle cx="7.355" cy="12.271" r=".708" /><circle
      cx="4.708"
      cy="9.824"
      r=".708"
    /><circle cx="7.355" cy="9.824" r=".708" /></g
  ><circle fill="#CCD6DD" cx="6.032" cy="11.032" r="1.817" /><path
    fill="#CCD6DD"
    d="M5 7h2v8H5z"
  /><path fill="#CCD6DD" d="M2 10h8v2H2z" /><circle
    fill="#B2C0C9"
    cx="6.032"
    cy="11.083"
    r="1.204"
...
@prop export let ariaLabel = '1f1f2 1f1f9';
-->
