...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#31373D" d="M5 16c0-4-5-3-4 1s3 5 3 5l1-6zm26 0c0-4 5-3 4 1s-3 5-3 5l-1-6z" /><path
    fill="#31373D"
  ...
  /><path
    fill="#31373D"
    d="M15 18.003c0 1.105-.896 2-2 2s-2-.895-2-2c0-1.104.896-1 2-1s2-.105 2 1zm10 0c0 1.105-.896 2-2 2s-2-.895-2-2c0-1.104.896-1 2-1s2-.105 2 1z"
  /><ellipse fill="#31373D" cx="15.572" cy="23.655" rx="1.428" ry="1" /><path
    fill="#31373D"
    d="M21.856 23.655c0 .553-.639 1-1.428 1-.79 0-1.429-.447-1.429-1 0-.553.639-1 1.429-1s1.428.448 1.428 1z"
  /><path
    fill="#99AAB5"
...
@prop export let ariaLabel = '1f98d';
-->
