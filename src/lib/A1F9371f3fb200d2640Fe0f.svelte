<script>
  ...
  export let ariaLabel = '1f937 1f3fb 200d 2640 fe0f';
</script>
...
<svg
  ...
  /><path fill="#9268CA" d="M27 21H9c-2.209 0-4 1.791-4 4v11h26V25c0-2.209-1.791-4-4-4z" /><path
    fill="#F7DECE"
    d="M14 5s-.003 5.308-5 5.936V17c0 4.971 4.029 9 9 9s9-4.029 9-9v-5.019C15.89 11.605 14 5 14 5z"
  /><path fill="#7450A8" d="M10 27h1v9h-1z" /><path
    fill="#E0AA94"
  ...
  /><path fill="#9268CA" d="M4 36h6v-8H5z" /><path fill="#7450A8" d="M25 27h1v9h-1z" /><path
    fill="#E0AA94"
  ...
  /><path fill="#9268CA" d="M32 36h-6v-8h5z" /><path
    fill="#C1694F"
...
@prop export let ariaLabel = '1f937 1f3fb 200d 2640 fe0f';
-->
