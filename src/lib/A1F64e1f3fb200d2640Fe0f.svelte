<script>
  ...
  export let ariaLabel = '1f64e 1f3fb 200d 2640 fe0f';
</script>
...
<svg
  ...
  /><path fill="#F7DECE" d="M9 5v12c0 4.971 4.029 9 9 9s9-4.029 9-9V5H9z" /><path
    fill="#292F33"
    d="M27.999 5L26 4H8v7c6 0 6-6 6-6s2 7 14 7l-.001-7z"
  /><path fill="#7450A8" d="M9 32h1v4H9zm17 0h1v4h-1z" /><circle
    fill="#DF1F32"
    cx="18"
    cy="23"
    r="1"
...
@prop export let ariaLabel = '1f64e 1f3fb 200d 2640 fe0f';
-->
