<script>
  export let size = '36';
  export let role = 'img';
  export let ariaLabel = '1f1f2 1f1ed';
</script>
...
<svg
  ...
  /><path fill="#EEE" d="M1.012 29.635L36 17v-6L.915 29.518c.032.039.063.079.097.117z" /><path
    fill="#FFF"
...
@prop export let ariaLabel = '1f1f2 1f1ed';
-->
