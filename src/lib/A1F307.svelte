...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#FFCC4D" d="M32 0H4C1.791 0 0 1.791 0 4v28h36V4c0-2.209-1.791-4-4-4z" /><path
    fill="#F4900C"
  ...
  /><circle fill="#FFE8B6" cx="18" cy="16" r="9.63" /><path
    fill="#485359"
    d="M10 36V15l4-4h2l4 4v21zm23-17c0-1-1-1-1-1h-7s-1 0-1 1v17h9V19z"
  /><path
    fill="#292F33"
    d="M28 25c0-1-1-1-1-1h-8c-1 0-1 1-1 1v11h10V25zm-17 2H6v-5s0-1-1-1H0v11c0 2.209 1.791 4 4 4h8v-8s0-1-1-1zm21 4c-1 0-1 1-1 1v4h1c2.209 0 4-1.791 4-4v-1h-4z"
  /><path
    d="M8 29h2v2H8zm-2 4h2v2H6zm10-16h2v2h-2zm0 4h2v2h-2zm-2 4h2v2h-2zm10 1h2v2h-2zm-2 4h2v2h-2zm7-10h2v2h-2zm0 4h2v2h-2z"
    fill="#FFCC4D"
  /></svg
>
...
@prop export let ariaLabel = '1f307';
-->
