<script>
  ...
  export let ariaLabel = '1f9d1 1f3fc 200d 1f384';
</script>
...
<svg
  ...
  /><circle fill="#F1F2F2" cx="32" cy="29" r="4" /><path
    fill="#F1F2F2"
    d="M32 12c0 1.104-.896 2-2 2H2c-1.104 0-2-.896-2-2v-1c0-1.104.896-2 2-2h28c1.104 0 2 .896 2 2v1z"
  /></svg
>
...
@prop export let ariaLabel = '1f9d1 1f3fc 200d 1f384';
-->
