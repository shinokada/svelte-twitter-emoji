...
<svg
  ...
  ><path
    fill="#662113"
    d="M34.539 33.488s1.18.215 1.18 1.256c0 1.043-1.042 1.256-2.084 1.256h-17.72C13.831 36 10 32 8 32l-.592 4H1v-2.936c0-2.084-.881-2.285-.881-3.211 0-2.084.672-4.395.672-4.395L17 33l17.539.488z"
  /><path
    fill="#C1694F"
  ...
  /><path fill="#D99E82" d="M10 20V.049c-.687.032-1.356.078-2 .133V20h2z" /></svg
>
...
@prop export let ariaLabel = '1f462';
-->
