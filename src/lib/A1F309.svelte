...
<svg
  ...
  /><g fill="#FFF"
    ...
    /><circle cx="10.5" cy="2.5" r=".5" /><circle cx="26.5" cy="11.5" r=".5" /><circle
      cx="7.5"
      cy="11.5"
      r=".5"
    /><circle cx="22" cy="5" r="1" /><circle cx="4" cy="17" r="1" /><circle
      cx="12"
      cy="7"
      r="1"
    /><circle cx="32" cy="17" r="1" /><circle cx="26.5" cy="5.5" r=".5" /><circle
      cx="31"
      cy="3"
      r="1"
    /><circle cx="31.5" cy="7.5" r=".5" /></g
  ></svg
>
...
@prop export let ariaLabel = '1f309';
-->
