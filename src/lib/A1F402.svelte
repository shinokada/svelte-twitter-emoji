...
<svg
  ...
  /><path
    fill="#CCD6DD"
    d="M10 12c-2 2-4.791-1-7-1-2.209 0-3-.434-3-.969 0-.535 1.791-.969 4-.969S12 10 10 12z"
  /><circle fill="#292F33" cx="6" cy="16" r="1" /></svg
>
...
@prop export let ariaLabel = '1f402';
-->
