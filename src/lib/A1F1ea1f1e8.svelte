<script>
  ...
  export let ariaLabel = '1f1ea 1f1e8';
</script>
...
<svg
  ...
  /><ellipse fill="#8ED2E7" cx="18" cy="17.5" rx="2" ry="3.5" /><path
    fill="#6DBE46"
  ...
  /><ellipse fill="#FFCC4D" cx="18" cy="22" rx="3" ry="1" /><path
    fill="#034EA2"
    d="M20 23c0 .828-.896 1-2 1s-2-.172-2-1 .896-2 2-2 2 1.172 2 2z"
  /><path fill="#ED1C23" d="M17 23c0-.828.448-2 1-2s1 1.172 1 2-.448 1-1 1-1-.172-1-1z" /><path
    fill="#CCD6DD"
  ...
  /><ellipse fill="#C1694F" cx="14" cy="13.5" rx="1" ry=".5" /><ellipse
    ...
    rx="1"
    ry=".5"
  /><ellipse fill="#C1694F" cx="22" cy="13.5" rx="1" ry=".5" /></svg
>
...
@prop export let ariaLabel = '1f1ea 1f1e8';
-->
