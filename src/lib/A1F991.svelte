...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#EA596E" d="M31 11C31 5 18 0 18 0v25s13-8 13-14z" /><path
    fill="#EA596E"
    d="M5.002 11c0-6 13-11 13-11v25c.001 0-13-8-13-14z"
  /><path fill="#F4ABBA" d="M27 11c0 3.833-9 12-9 12s-9-8.167-9-12c0-5 9-11 9-11s9 6 9 11z" /><path
    fill="#BE1931"
...
@prop export let ariaLabel = '1f991';
-->
