...
<svg
  ...
  /><path
    fill="#AA8DD8"
    d="M13 10.227C13 3.951 18 0 18 0s5 3.951 5 10.227S20.762 25 18 25s-5-8.497-5-14.773z"
  /><path
    fill="#AA8DD8"
    d="M14 30c0-3.313 2.344-6 4-6 1.656 0 4 2.687 4 6s-4 6-4 6-4-2.687-4-6z"
  /><path
    fill="#9266CC"
    d="M25 24.5c0 1.933-1.567 3.5-3.5 3.5h-7c-1.934 0-3.5-1.567-3.5-3.5s1.566-3.5 3.5-3.5h7c1.933 0 3.5 1.567 3.5 3.5z"
  /></svg
>
...
@prop export let ariaLabel = '269c';
-->
