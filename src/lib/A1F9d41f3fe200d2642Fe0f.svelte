<script>
  ...
  export let ariaLabel = '1f9d4 1f3fe 200d 2642 fe0f';
</script>
...
<svg
  ...
  /><path fill="#AF7E57" d="M18 29.675c-4.167 0-7.292-2.2 0-2.2s4.167 2.2 0 2.2" /></svg
>
...
@prop export let ariaLabel = '1f9d4 1f3fe 200d 2642 fe0f';
-->
