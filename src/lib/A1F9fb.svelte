...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#E1E8ED" d="M7 0h17v24H7z" /><path fill="#99AAB5" d="M7 12h17v12H7z" /><ellipse
    fill="#CCD6DD"
    cx="7"
    cy="12"
    rx="7"
    ry="12"
  /><ellipse fill="#E1E8ED" cx="24" cy="12" rx="8" ry="12" /><path
    fill="#E1E8ED"
  ...
  /><ellipse fill="#99AAB5" cx="6" cy="12" rx="3" ry="5" /><path
    fill="#66757F"
...
@prop export let ariaLabel = '1f9fb';
-->
