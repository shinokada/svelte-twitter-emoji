...
<svg
  ...
  /><path fill="#F4900C" d="M21.826 17.075l7.424-9.481 3.722 9.481z" /><path
    fill="#FFCC4D"
  ...
  /><circle fill="#DD2E44" cx="32.852" cy="22" r="1.986" /><circle
    ...
    cy="22"
    r="2.412"
  /><circle fill="#DD2E44" cx="3.061" cy="22" r="1.986" /><path
    fill="#FFAC33"
...
@prop export let ariaLabel = '1f451';
-->
