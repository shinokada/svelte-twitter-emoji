...
<svg
  ...
  /><path
    fill="#292F33"
    d="M10 18.123c0 .828.671 1.5 1.5 1.5s1.5-.672 1.5-1.5c0-.829-.671 0-1.5 0s-1.5-.829-1.5 0z"
  /><g fill="#77B255"
    ><ellipse cx="27.5" cy="24" rx="1.5" ry="1" /><ellipse
      cx="23.5"
      cy="24"
      rx="1.5"
      ry="1"
    /><ellipse cx="19.5" cy="24" rx="1.5" ry="1" /><ellipse
      cx="21.5"
      cy="26"
      rx="1.5"
      ry="1"
    /><ellipse cx="25.5" cy="26" rx="1.5" ry="1" /></g
  ><path
    fill="#FFF"
    d="M6 22c-.389 0-1-1-1-1h2s-.611 1-1 1zm-2 .469C3.611 22.469 3 21 3 21h2s-.611 1.469-1 1.469zM2 23c-.389 0-1-2-1-2h2s-.611 2-1 2z"
  /></svg
>
...
@prop export let ariaLabel = '1f40a';
-->
