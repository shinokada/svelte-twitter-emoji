<script>
  ...
  export let ariaLabel = '1f937 1f3fb';
</script>
...
<svg
  ...
  /><path fill="#FA743E" d="M27 21H9c-2.209 0-4 1.791-4 4v11h26V25c0-2.209-1.791-4-4-4z" /><path
    fill="#F7DECE"
  ...
  /><path fill="#FA743E" d="M4 36h6v-8H5z" /><path fill="#DD551F" d="M25 27h1v9h-1z" /><path
    fill="#E0AA94"
  ...
  /><path fill="#FA743E" d="M32 36h-6v-8h5z" /><path
    fill="#C1694F"
...
@prop export let ariaLabel = '1f937 1f3fb';
-->
