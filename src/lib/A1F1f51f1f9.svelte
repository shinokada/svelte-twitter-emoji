<script>
  ...
  export let ariaLabel = '1f1f5 1f1f9';
</script>
...
<svg
  ...
  /><path fill="#D52B1E" d="M32 5H15v26h17c2.209 0 4-1.791 4-4V9c0-2.209-1.791-4-4-4z" /><path
    fill="#FFCC4D"
  ...
  /><path fill="#D52B1E" d="M11 13v7c0 2.209 1.791 4 4 4s4-1.791 4-4v-7h-8z" /><path
    fill="#FFF"
    d="M12 14v6c0 1.656 1.343 3 3 3s3-1.344 3-3v-6h-6z"
  /><path fill="#829ACD" d="M13 17h4v2h-4z" /><path fill="#829ACD" d="M14 16h2v4h-2z" /><path
    fill="#039"
...
@prop export let ariaLabel = '1f1f5 1f1f9';
-->
