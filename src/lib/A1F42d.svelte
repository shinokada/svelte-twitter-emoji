...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><circle fill="#99AAB5" cx="8.5" cy="9.5" r="8.5" /><circle
    fill="#99AAB5"
    cx="27.5"
    cy="9.5"
    r="8.5"
  /><path
    fill="#F4ABBA"
    d="M13.812 10.031c0 3.228-2.617 5.844-5.844 5.844s-5.844-2.616-5.844-5.844c0-3.227 2.617-5.844 5.844-5.844s5.844 2.617 5.844 5.844zm20.063 0c0 3.228-2.617 5.844-5.844 5.844-3.227 0-5.844-2.616-5.844-5.844 0-3.227 2.617-5.844 5.844-5.844 3.227.001 5.844 2.617 5.844 5.844z"
  /><path fill="#99AAB5" d="M30 18c0 7.18-8 15-12 15S6 25.18 6 18s7-9 12-9 12 1.82 12 9z" /><path
    fill="#F4ABBA"
  ...
  ><path
    fill="#272B2B"
    d="M12 21s0-2 2-2 2 2 2 2v2s0 2-2 2-2-2-2-2v-2zm8 0s0-2 2-2 2 2 2 2v2s0 2-2 2-2-2-2-2v-2z"
  /></svg
>
...
@prop export let ariaLabel = '1f42d';
-->
