...
<svg
  ...
  ><path
    fill="#F4900C"
    d="M13.431 9.802c.658 2.638-8.673 10.489-11.244 4.098C.696 10.197-.606 2.434.874 2.065c1.48-.368 11.9 5.098 12.557 7.737z"
  /><path
    fill="#A0041E"
  ...
  /><path
    fill="#F4900C"
    d="M22.557 9.802C21.9 12.441 31.23 20.291 33.802 13.9c1.49-3.703 2.792-11.466 1.312-11.835-1.48-.368-11.899 5.098-12.557 7.737z"
  /><path
    fill="#A0041E"
...
@prop export let ariaLabel = '1f98a';
-->
