...
<svg
  ...
  /><path
    fill="#9AAAB4"
    d="M33 30c0 1.104-.896 2-2 2H5c-1.104 0-2-.896-2-2s.896-2 2-2h26c1.104 0 2 .896 2 2z"
  /><path
    fill="#CCD6DD"
    d="M35 32c0 1.104-.896 2-2 2H3c-1.104 0-2-.896-2-2s.896-2 2-2h30c1.104 0 2 .896 2 2z"
  /><path
    fill="#E1E8ED"
    d="M36 33.5c0 .828-.672 1.5-1.5 1.5h-33C.671 35 0 34.328 0 33.5S.671 32 1.5 32h33c.828 0 1.5.672 1.5 1.5z"
  /><path
    fill="#9AAAB4"
    d="M33 10c0-1.104-.956-2-2.133-2H5c-1.179 0-2 .896-2 2 0 .751.386 1.398 1 1.74V13h4v-1h4v1h4v-1h4v1h4v-1h4v1h4v-1.312c.599-.354 1-.975 1-1.688z"
  /><path
    fill="#CCD6DD"
    d="M2 8.444C2 7.413 3.012 7 3.012 7l14.904-7 15.047 7S34 7.231 34 8.45V9H2v-.556z"
  /><path
    fill="#9AAAB4"
  ...
  /><path
    fill="#CCD6DD"
    d="M34 9c0 .552-.447 1-1 1H3c-.552 0-1-.448-1-1s.448-1 1-1l30 .006c.553 0 1 .442 1 .994z"
  /></svg
>
...
@prop export let ariaLabel = '1f3db';
-->
