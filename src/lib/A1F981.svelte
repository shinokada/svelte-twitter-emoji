...
<svg
  ...
  /><path
    fill="#E6AAAA"
    d="M11.052 8.997c.871 1.393.447 3.229-.946 4.1-1.394.871-2.608.797-3.479-.596-.871-1.394-.186-4.131.324-4.45.51-.319 3.23-.448 4.101.946z"
  /><path
    fill="#FFCC4D"
  ...
  /><path
    fill="#FFCC4D"
    d="M18 7.125h-.002C5.167 7.126 7.125 12.083 8.5 18.667 9.875 25.25 10.384 27 10.384 27h15.228s.51-1.75 1.885-8.333C28.872 12.083 30.829 7.126 18 7.125z"
  /><path
    fill="#272B2B"
    d="M12 16s0-1.5 1.5-1.5S15 16 15 16v1.5s0 1.5-1.5 1.5-1.5-1.5-1.5-1.5V16zm9 0s0-1.5 1.5-1.5S24 16 24 16v1.5s0 1.5-1.5 1.5-1.5-1.5-1.5-1.5V16z"
  /><path
    fill="#FFE8B6"
  ...
  /><circle fill="#D99E82" cx="11.5" cy="24.5" r=".5" /><circle
    fill="#D99E82"
    cx="10.5"
    cy="26.5"
    r=".5"
  /><circle fill="#D99E82" cx="12.5" cy="27.5" r=".5" /><circle
    fill="#D99E82"
    cx="24.5"
    cy="24.5"
    r=".5"
  /><circle fill="#D99E82" cx="25.5" cy="26.5" r=".5" /><circle
    fill="#D99E82"
    cx="23.5"
    cy="27.5"
    r=".5"
...
@prop export let ariaLabel = '1f981';
-->
