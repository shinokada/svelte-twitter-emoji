<script>
  ...
  export let ariaLabel = '1f1f5 1f1fe';
</script>
...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#0038A8" d="M0 27c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4v-4H0v4z" /><path
    fill="#EEE"
    d="M0 13h36v10H0z"
  /><path fill="#D52B1E" d="M32 5H4C1.791 5 0 6.791 0 9v4h36V9c0-2.209-1.791-4-4-4z" /><path
    d="M22 18c0 2.209-1.791 4-4 4s-4-1.791-4-4 1.791-4 4-4 4 1.791 4 4z"
  /><path
    fill="#EEE"
    d="M21.75 18c0 2.071-1.68 3.75-3.75 3.75s-3.75-1.68-3.75-3.75 1.679-3.75 3.75-3.75 3.75 1.679 3.75 3.75z"
  /><path
    d="M21.25 18c0 1.795-1.455 3.25-3.25 3.25s-3.25-1.455-3.25-3.25 1.455-3.25 3.25-3.25 3.25 1.455 3.25 3.25z"
  /><path
    fill="#EEE"
  ...
  /><path
    d="M20.5 18c0 1.381-1.119 2.5-2.5 2.5s-2.5-1.119-2.5-2.5 1.12-2.5 2.5-2.5 2.5 1.119 2.5 2.5z"
  /><circle fill="#EEE" cx="18" cy="18" r="2.4" /><path
    fill="#FFAC33"
...
@prop export let ariaLabel = '1f1f5 1f1fe';
-->
