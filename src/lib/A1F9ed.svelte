...
<svg
  ...
  ><circle fill="#F4900C" cx="18" cy="18" r="18" /><circle
    ...
    cy="18"
    r="14.5"
  /><circle fill="#F5F8FA" cx="18" cy="18" r="13" /><path
    fill="#CCD6DD"
  ...
  /><path fill="#292F33" d="M17.343 20.748l8.777 5.381-5.379-8.778z" /><path
    fill="#DD2E44"
...
@prop export let ariaLabel = '1f9ed';
-->
