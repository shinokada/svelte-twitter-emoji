...
<svg
  ...
  ><ellipse fill="#99AAB5" cx="18" cy="26" rx="18" ry="10" /><ellipse
    ...
    rx="18"
    ry="10"
  /><path fill="#F5F8FA" d="M18 31C3.042 31 1 16 1 12h34c0 2-1.958 19-17 19z" /><path
    fill="#CCD6DD"
  ...
  /><ellipse fill="#8A4B38" cx="18" cy="13" rx="15" ry="7" /><path
    fill="#D99E82"
...
@prop export let ariaLabel = '2615';
-->
