<script>
  ...
  export let ariaLabel = '1f1e7 1f1f7';
</script>
...
<svg
  ...
  /><path fill="#FEDF01" d="M32.728 18L18 29.124 3.272 18 18 6.875z" /><circle
    fill="#002776"
    cx="17.976"
    cy="17.924"
    r="6.458"
  ...
  /><path fill="#3B88C3" d="M19 20.233h1v1h-1z" /></svg
>
...
@prop export let ariaLabel = '1f1e7 1f1f7';
-->
