<script>
  ...
  export let ariaLabel = '1f646 1f3ff';
</script>
...
<svg
  ...
  /><path
    fill="#FA743E"
    d="M32 6.625L29 5l-2 1.625s3 7.25 3 11.125S26.5 27 26.5 27h-17S6 21.625 6 17.75 9 6.625 9 6.625L7 5 4 6.625S0 13.75 0 17.75 5.5 36 5.5 36h25S36 21.75 36 17.75 32 6.625 32 6.625z"
  /><path
    fill="#7C533E"
    d="M15 22v6c0 1.657 1.343 3 3 3s3-1.343 3-3v-6h-6zm4.24-19.604c.042-.521.593-.727 1.146-.708 0 0 5.456.311 7.521 1.271C30.522 4.174 32 6.625 32 6.625h-5S25.917 5.104 25.062 4.5c-.881-.623-4.222-1.215-4.719-1.312s-1.145-.271-1.103-.792zm-2.48 0c-.042-.521-.593-.727-1.146-.708 0 0-5.456.311-7.521 1.271C5.478 4.174 4 6.625 4 6.625h5s1.083-1.521 1.938-2.125c.881-.623 4.222-1.215 4.719-1.312.496-.098 1.145-.271 1.103-.792z"
  /><path
    fill="#3D2E24"
    d="M22 21h-8s1 2 4 2 4-2 4-2zm-3-1.5h-2c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h2c.276 0 .5.224.5.5s-.224.5-.5.5z"
  /><path
...
@prop export let ariaLabel = '1f646 1f3ff';
-->
