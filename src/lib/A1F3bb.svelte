...
<svg
  ...
  /><path fill="#292F33" d="M34 3L19 20l-3-3L33 2z" /><path
    fill="#642116"
  ...
  /><path
    fill="#CCD6DD"
    d="M4.628 29.935L28.8 5.807l.53.531L5.16 30.466zm.869.869L29.67 6.676l.531.532L6.028 31.335z"
  /><path
    fill="#F18F26"
  ...
  /><path fill="#292F33" d="M2 32l4-5s1 0 2 1 1 2 1 2l-5 4-2-2z" /><circle
    fill="#642116"
    cx="33"
    cy="8"
    r="1"
  /><circle fill="#642116" cx="35" cy="6" r="1" /><circle
    fill="#642116"
    cx="28"
    cy="3"
    r="1"
  /><circle fill="#642116" cx="30" cy="1" r="1" /></svg
>
...
@prop export let ariaLabel = '1f3bb';
-->
