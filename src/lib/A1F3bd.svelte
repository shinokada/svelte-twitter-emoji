...
<svg
  ...
  on:mouseout
  viewBox="0 0 36 36"
  ><path fill="#269" d="M6.318 1.031c1.499 1.499 13.184 8.685 23.386 0V12H6.318V1.031z" /><path
    fill="#55ACEE"
  ...
  /><path
    fill="#FFD983"
    d="M4.192 25.616c-.433 3.006-1.002 5.832-1.56 7.366l28.506-17.637c.177-3.329.976-5.184 3.323-8.717L4.192 25.616z"
  /></svg
>
...
@prop export let ariaLabel = '1f3bd';
-->
